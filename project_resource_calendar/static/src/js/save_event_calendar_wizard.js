        ...
        if (!options || !options.buttons) {
            ...
            if (!readonly) {
                options.buttons.unshift({
                    ...
                    classes: "btn-primary",
                    click: function () {
                        /* Custom Udem Code for displaying Validation Wizard for double booking
                         * Calender event on save wizard display
                        ...
                        if(self.form_view.modelName == 'calendar.event'){
                            ...
                            var equipment_ids  = [];
                            self.form_view.renderer.state.data.equipment_ids.data.forEach(function(equipment_id){
                                equipment_ids.push(equipment_id.data.id);
                            });

                            var partner_ids  = [];
                            self.form_view.renderer.state.data.partner_ids.data.forEach(function(partner_id){
                            ...
                            self._rpc({
                                ...
                                args: [
                                       self.form_view.renderer.state.data.id,
